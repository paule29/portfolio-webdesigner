...
<!-- début section experience -->

<section class="experience" id="experience">
<h1 class="heading"> Mes <span>Experiences</span> </h1>
...
<section class="contact" id="contact">
    <h1 class="heading"> Me <span>Contacter</span> </h1>
    <div class="row">
        <div class="content">
        ...
        <form action="handler.php" method="POST">
            ...
            <input type="email" placeholder="votre email" class="box" name='user_mail'>
            <input type="text" placeholder="projet" class="box" name='message_topic'>
            <textarea name="user_message" cols="30" rows="10" class="box message" placeholder="votre message"></textarea>
